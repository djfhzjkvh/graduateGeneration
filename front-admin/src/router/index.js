...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'report/overview',        component: () => import('@/views/report/overview.vue'),         meta: { title: '经营报表', parent: '报表统计' } },
      ...
      { path: 'ops/config',             component: () => import('@/views/ops/config.vue'),              meta: { title: '系统配置', parent: '系统运维' } },
      { path: 'ops/jobs',               component: () => import('@/views/ops/jobs.vue'),                meta: { title: '任务调度', parent: '系统运维' } },
      { path: 'ops/logs',               component: () => import('@/views/ops/logs.vue'),                meta: { title: '日志中心', parent: '系统运维' } },
      { path: 'profile',                component: () => import('@/views/profile/index.vue'),           meta: { title: '个人信息', parent: '个人中心' } },
    ]
  },
