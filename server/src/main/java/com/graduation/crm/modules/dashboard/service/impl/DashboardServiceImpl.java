...
public class DashboardServiceImpl implements DashboardService {
    ...
    public AppWorkbenchVO appWorkbench(Long userId) {
        ...
        vo.setHighIntentCustomerCount(dashboardMapper.countHighIntentCustomers(userId, null));
        ...
        vo.setHighIntentCustomers(dashboardMapper.selectHighIntentCustomers(userId, null, 5));
        return vo;
    }
    ...
    public ManagerDashboardVO managerDashboard(Long managerId) {
        ...
        vo.setTeamHighIntentCustomerCount(dashboardMapper.countHighIntentCustomers(null, managerId));
        vo.setAdvisorRankList(dashboardMapper.selectAdvisorRank(managerId));
        return vo;
    }
    ...
    public AdminOverviewVO adminOverview() {
        ...
        vo.setHighIntentCustomerCount(dashboardMapper.countHighIntentCustomers(null, null));
